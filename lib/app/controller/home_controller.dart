...
class HomeController extends GetxController implements GetxService {
  ...
  void onServices(int uid) {
    ...
    Get.toNamed(AppRouter.getServicesRoutes(), arguments: [uid])?.then((value) => {
       refresh()
    });
  }
  ...
  void onSpecialist(int uid) {
    ...
    Get.toNamed(AppRouter.getSpecialistRoutes(), arguments: [uid])?.then((value) => {
      refresh()
    });
  }
  ...
  void onAllSpecialist() {
    ...
    Get.toNamed(AppRouter.getTopSpecialistRoutes())?.then((value) => {
      refresh()
    });
  }
  ...
  void onAllOffers() {
    ...
    Get.toNamed(AppRouter.getTopOffersRoutes())?.then((value) => {
      refresh()
    });
  }
  ...
  void onSearch() {
    Get.delete<SearchControllers>(force: true);
  ...
  void onCheckout() {
    ...
    debugPrint(Get
        .find<ServiceCartController>()
        .servicesFrom
        .toString());
    if (Get
        .find<ServiceCartController>()
        .servicesFrom == 'individual') {
      Get.delete<IndividualCheckoutController>(force: true);
/*      Get.toNamed(AppRouter.getIndividualCheckout());*/
      Get.toNamed(AppRouter.getIndividualCheckout())!.then((value) {
        refresh();
      });
    } else {
      Get.delete<CheckoutController>(force: true);
      Get.toNamed(AppRouter.getCheckoutRoutes())?.then((value) {
        refresh();
      });;
    }
  }
