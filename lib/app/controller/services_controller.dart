...
import 'display_image_controller.dart';
...
class ServicesController extends GetxController
  ...
  void onInit() {
    ...
    userId = parser.getUserId() != null ? parser.getUserId().toString() :  "";
    getSalonDetails();
  ...
  Future<void> getSalonDetails() async {
    ...
    var response = await parser.salonDetails({"id": salonId,'uid':userId});
