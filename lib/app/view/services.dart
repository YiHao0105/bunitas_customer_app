                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(image: NetworkImage('${Environments.apiBaseURL}storage/images/${value.salonDetails.cover.toString()}'), fit: BoxFit.fill),
                            ),
                            child: Stack(
                              children: [
                                Align(
                                        ...
                                        children: [
                                          ...
                                          CircleAvatar(
                                            ...
                                            child: IconButton(
                                              ...
                                              onPressed: () {
                                                value.onDisplay('${value.salonDetails.cover.toString()}');
                                              },
                                            ),
                                          ),
                                        ],
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: const TextStyle(color: ThemeProvider.whiteColor, fontFamily: 'bold', fontSize: 17),
                                      ),
                                      Padding(
                                        ...
                                        child: Text(
                                          ...
                                          overflow: TextOverflow.ellipsis,
                                          style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 13),
                                        ),
                                      ),
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                ...
                                                TextSpan(
                                                  text: ' (${value.salonDetails.totalRating} ${'Reviews)'.tr}',
                                                  style: const TextStyle(fontSize: 12, color: ThemeProvider.whiteColor),
                                                ),
                                              ],
                                            ),
                                          ),
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            value.dayList[value.salonDetails.timing![index].day as int],
                                              ...
                                              children: [
                                                    ...
                                                    RichText(
                                                      text: TextSpan(
                                                        children: [
                                                          ...
                                                          TextSpan(
                                                            text: '${' Get Direction - '.tr}${value.getDistance}KM',
                                                ...
                                                ClipRRect(
                                                  ...
                                                  child: SizedBox.fromSize(
                                                    ...
                                                    child: GoogleMap(onMapCreated: value.onMapCreated(), markers: value.markers, initialCameraPosition: CameraPosition(target: LatLng(value.salonDetails.lat as double, value.salonDetails.lng as double), zoom: 5), myLocationButtonEnabled: false, zoomControlsEnabled: false),
                                                  ),
                                                ),
                                              ],
                                            ),
                                      ...
                                      children: [
                                        ...
                                        if (tabID == 1)
                                          for (var item in value.categoriesList)
                                            InkWell(
                                              onTap: () {
                                                value.onServicesView(item.id as int, item.name.toString());
                                              },
                                              child: Column(
                                                children: [
                                                  Padding(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    item.services.toString() + '  Type'.tr,
                                                                    style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 12),
                                                                  ),
                                                                ],
                                                              ),
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        InkWell(
                                                          onTap: () {
                                                            value.onPackagesDetails(item.id as int, item.name.toString());
                                                          },
                                                          child: Text(
                                                            'View'.tr,
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        Get.find<ServicesController>().currencySide == 'left' ? '${Get.find<ServicesController>().currencySymbol}${item.price}' : '  ${item.price}${Get.find<ServicesController>().currencySymbol}',
                                                        style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 12),
                                                      ),
                                                    ],
                                                  )
                                              ...
                                              GridView.count(
                                                ...
                                                children: List.generate(
                                                  ...
                                                  (index) {
                                                    return InkWell(
                                                      onTap: () {
                                                        value.onDisplay('${value.gallery[index].toString()}');
                                                      },
                                                      child: Padding(
                                                        padding: const EdgeInsets.all(10.0),
                                                        child: ClipRRect(
