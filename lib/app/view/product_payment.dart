                            ...
                            /*
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        value.currencySide == 'left'
                                            ? '${value.currencySymbol}${value.subTotal.toString()}'
                                            : '${value.subTotal.toString()}${value.currencySymbol}',
                                        style: const TextStyle(
                                            color: ThemeProvider.blackColor,
                                            fontFamily: 'bold')),
                                  ],
                             ...
                             Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      value.currencySide == 'left'
                                          ? '${value.currencySymbol}${value.depositePrice.toString()}'
                                          : '${value.depositePrice.toString()}${value.currencySymbol}',
                                    ),
                                  ],
                                ),
                              ),
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      value.currencySide == 'left'
                                          ? '${value.currencySymbol}${value.bookingFee.toString()}'
                                          : '${value.bookingFee.toString()}${value.currencySymbol}',
                                    ),
                                  ],
                                ),
                              ),
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      value.currencySide == 'left'
                                          ? '${value.currencySymbol}${value.processingFee.toString()}'
                                          : '${value.processingFee.toString()}${value.currencySymbol}',
                                    ),
                                  ],
                                ),
                              ),*/
                             ...
                             //Commented By geeks on Aug 2,2023
                             /* Padding(
                                padding:
                                    const EdgeInsets.symmetric(vertical: 5),
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        value.currencySide == 'left'
                                            ? '${value.currencySymbol}${value.payNow.toString()}'
                                            : '${value.payNow.toString()}${value.currencySymbol}',
                                        style: const TextStyle(
                                            color: ThemeProvider.blackColor,
                                            fontFamily: 'bold')),
                                  ],
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        value.currencySide == 'left'
                                            ? '${value.currencySymbol}${value.payAtSalon.toString()}'
                                            : '${value.payAtSalon.toString()}${value.currencySymbol}',
                                        style: const TextStyle(
                                            color: ThemeProvider.blackColor,
                                            fontFamily: 'bold')),
                                  ],
