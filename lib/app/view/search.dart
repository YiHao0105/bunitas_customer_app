                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                value.title.length > 30 ? '${value.title.substring(0, 30)}...' : value.title.toString(),
                                ...
                                child: Row(
                                  ...
                                  children: List.generate(
                                      ...
                                      (index) => GestureDetector(
                                            onTap: () {
                                              value.onSpecialist(value.individualList[index].uid as int);
                                            },
                                            child: Padding(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    value.individualList[index].firstName!,
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      border: Border(
                                        bottom: BorderSide(color: ThemeProvider.backgroundColor),
                                      ),
                                    ),
                                    child: Column(
                                        children: List.generate(
                                                      ...
                                                      children: [
                                                        SizedBox(
                                                          ...
                                                          child: Text(
                                                            ...
                                                            overflow: TextOverflow.ellipsis,
                                                            style: const TextStyle(color: ThemeProvider.greyColor, fontFamily: 'bold', fontSize: 12),
                                                          ),
                                                        ),
                                                      ],
                                                    ),
