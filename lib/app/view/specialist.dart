...
class _SpecialistScreenState extends State<SpecialistScreen> {
                        ...
                        children: [
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      'OPEN'.tr,
                                      style: const TextStyle(color: ThemeProvider.greenColor, fontSize: 10),
                                    ),
                                  ),
                                ),
                              ),
                                ...
                                children: [
                                  WidgetSpan(
                                    child: Icon(
                                      Icons.star,
                                      size: 15,
                                      color: value.individualDetails.rating! >= 1 ? ThemeProvider.orangeColor : ThemeProvider.greyColor,
                                    ),
                                  ),
                                  WidgetSpan(
                                    child: Icon(
                                      Icons.star,
                                      size: 15,
                                      color: value.individualDetails.rating! >= 2 ? ThemeProvider.orangeColor : ThemeProvider.greyColor,
                                    ),
                                  ),
                                  WidgetSpan(
                                    child: Icon(
                                      Icons.star,
                                      size: 15,
                                      color: value.individualDetails.rating! >= 3 ? ThemeProvider.orangeColor : ThemeProvider.greyColor,
                                    ),
                                  ),
                                  WidgetSpan(
                                    child: Icon(
                                      Icons.star,
                                      size: 15,
                                      color: value.individualDetails.rating! >= 4 ? ThemeProvider.orangeColor : ThemeProvider.greyColor,
                                    ),
                                  ),
                                  WidgetSpan(
                                    child: Icon(
                                      Icons.star,
                                      size: 15,
                                      color: value.individualDetails.rating! >= 5 ? ThemeProvider.orangeColor : ThemeProvider.greyColor,
                                    ),
                                  ),
                                  TextSpan(
                                    text: ' ( ${value.individualDetails.totalRating} ${'Reviews)'.tr}',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                //Commented By Geeks on 3 Aug 2023
                                /*Column(
                                  children: [
                                    InkWell(
                                      onTap: () {
                              ...
                              children: [
                                TabBar(
                                  ...
                                  indicator: const UnderlineTabIndicator(
                                    borderSide: BorderSide(width: 2.0, color: ThemeProvider.appColor),
                                  ),
                                  tabs: [
                                    Tab(
                                      text: 'Basic Info'.tr,
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            value.dayList[value.individualDetails.timing![index].day as int],
                                              ...
                                              children: [
                                                    ...
                                                    RichText(
                                                      text: TextSpan(
                                                        children: [
                                                          ...
                                                          TextSpan(
                                                            text: ' Get Direction - ${value.getDistance}${'KM'.tr}',
                                                            style: const TextStyle(fontSize: 12, color: ThemeProvider.orangeColor),
                                                          ),
                                                        ],
                                                      ),
                                                    ),
                                                ...
                                                ClipRRect(
                                                  ...
                                                  child: SizedBox.fromSize(
                                                    ...
                                                    child: GoogleMap(onMapCreated: value.onMapCreated(), markers: value.markers, initialCameraPosition: CameraPosition(target: LatLng(value.individualDetails.lat as double, value.individualDetails.lng as double), zoom: 5), myLocationButtonEnabled: false, zoomControlsEnabled: false),
                                                  ),
                                                ),
                                              ],
                                            ),
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      InkWell(
                                                                        onTap: () {
                                                                          value.onServicesView(value.categoriesList[index].id as int, value.categoriesList[index].name.toString());
                                                                        },
                                                                        child: Text(
                                                                          'View'.tr,
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          Get.find<SpecialistController>().currencySide == 'left' ? '${Get.find<SpecialistController>().currencySymbol}${value.packagesList[index].price}' : '  ${value.packagesList[index].price}${Get.find<SpecialistController>().currencySymbol}',
                                                                          style: const TextStyle(
                                                                            color: ThemeProvider.greyColor,
                                                                            fontSize: 12,
                                                                          ),
                                                  ...
                                                  child: Column(
                                                    children: [
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        Icon(Icons.star, color: value.ownerReviewsList[index].rating! >= 1 ? ThemeProvider.orangeColor : ThemeProvider.greyColor, size: 15),
                                                                        Icon(Icons.star, color: value.ownerReviewsList[index].rating! >= 2 ? ThemeProvider.orangeColor : ThemeProvider.greyColor, size: 15),
                                                                        Icon(Icons.star, color: value.ownerReviewsList[index].rating! >= 3 ? ThemeProvider.orangeColor : ThemeProvider.greyColor, size: 15),
                                                                        Icon(Icons.star, color: value.ownerReviewsList[index].rating! >= 4 ? ThemeProvider.orangeColor : ThemeProvider.greyColor, size: 15),
                                                                        Icon(Icons.star, color: value.ownerReviewsList[index].rating! >= 5 ? ThemeProvider.orangeColor : ThemeProvider.greyColor, size: 15),
                                                                      ],
                                                                    ),
                                                                  ],
                                                                ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          value.ownerReviewsList[index].notes!,
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Center(
                    ...
                    child: Text('Treatments'.tr, style: segmentText(1)),
                  )),
                ),
              ),
            ),
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Center(
                      child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 30),
                    child: Text('Bundles'.tr, style: segmentText(2)),
                  )),
                ),
              ),
            ),
  ...
  segmentText(val) {
    return TextStyle(fontSize: 12, color: tabID == val ? ThemeProvider.whiteColor : ThemeProvider.greyColor);
  }
}
