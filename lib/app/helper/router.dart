...
import '../backend/binding/display_binding.dart';
import '../view/display_image.dart';
...
class AppRouter {
  ...
  static const String displayRoutes = '/display_image';
  ...
  static String getDisplayRoute() => displayRoutes;
  ...
  GetPage(name: displayRoutes,
  page: () => const DisplayImage(),
