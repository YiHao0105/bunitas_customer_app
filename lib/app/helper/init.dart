...
import '../backend/parse/display_parse.dart';
import '../controller/account_chat_controller.dart';
  ...
  Future<void> dependencies() async {
    ...
    Get.lazyPut(
        () => ComplaintsParser(
            sharedPreferencesManager: Get.find(), apiService: Get.find()),
        fenix: true);
    Get.lazyPut(() => DisplayParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
